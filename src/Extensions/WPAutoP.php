...
/**
 * WordPress functionality to add paragraphs to text
 */

class WPAutoP extends Extension
{
    ...
    public function wpautop($pee, $br = true)
    {
        ...
        $pee = $this->owner->wp_replace_in_html_tags($pee, array( "\n" => ' <!-- wpnl --> ' ));
    ...
    {
        // Find all elements.
        $textarr = $this->owner->wp_html_split($haystack);
        $changed = false;
    ...
    {
        return preg_split($this->owner->get_html_split_regex(), $input, -1, PREG_SPLIT_DELIM_CAPTURE);
    }
